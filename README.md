...
**最新版本 0.6.11**，发布于 2026-09-24。需要 Android 7.0
或更高版本（API 24）。
...
| 下载 | 适合 | 大小 |
| --- | --- | --- |
| [universal](https://github.com/liveinaus/bemplayer/releases/download/v0.6.11/bemplayer-0.6.11-universal.apk) | 适用于所有 Android TV 设备 | 19.4 MB |
...
用 `sha256sum bemplayer-0.6.11-universal.apk` 校验其中一个。
